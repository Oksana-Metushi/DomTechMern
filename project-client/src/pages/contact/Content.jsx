...
const Content = () => {
    return (
        <div className='flex flex-col md:flex-row md:gap-16 py-[10%] items-center section-container'>
            ...
            <div className="space-y-8 md:w-1/2 mx-auto w-full md:order-2 order-1 font-tek text-3xl text-slate-400 mb-6">
